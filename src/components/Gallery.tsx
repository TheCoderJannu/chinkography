...
export default function Gallery() {
  ...
  const mediaItems: MediaItem[] = [
    { id: 1, type: 'image', url: '/imgs/1stofit.webp', title: 'Urban Portrait', category: 'portrait' },
    { id: 2, type: 'image', url: '/imgs/2ndofit.webp', title: 'Fashion Editorial', category: 'fashion' },
    { id: 3, type: 'image', url: '/imgs/3rdofit.webp', title: 'Fashion Editorial', category: 'fashion' },
    ...
    { id: 7, type: 'image', url: '/imgs/7thofit.webp', title: 'Urban Portrait', category: 'portrait' },
    { id: 8, type: 'image', url: '/imgs/8thofit.webp', title: 'Fashion Editorial', category: 'fashion' },
    { id: 9, type: 'image', url: '/imgs/9thofit.webp', title: 'Fashion Editorial', category: 'fashion' },
     {
      id: 10,
      type: 'video',
    ...
    { id: 13, type: 'image', url: '/imgs/13thofit.webp', title: 'Portrait Art', category: 'portrait' },
    { id: 14, type: 'image', url: '/imgs/14thofit.webp', title: 'Fashion Week', category: 'fashion' },
    { id: 15, type: 'image', url: '/imgs/15thofit.webp', title: 'Fashion Week', category: 'fashion' },
      {
      id: 16,
      type: 'video',
    ...
    { id: 19, type: 'image', url: '/imgs/19thofit.webp', title: 'Portrait Art', category: 'portrait' },
    { id: 20, type: 'image', url: '/imgs/20thofit.webp', title: 'Fashion Week', category: 'fashion' },
    { id: 21, type: 'image', url: '/imgs/21stofit.webp', title: 'Fashion Week', category: 'fashion' },
    {
      id: 22,
      type: 'video',
    ...
    { id: 25, type: 'image', url: '/imgs/25thofit.webp', title: 'Portrait Art', category: 'portrait' },
    { id: 26, type: 'image', url: '/imgs/26thofit.webp', title: 'Fashion Week', category: 'fashion' },
    { id: 27, type: 'image', url: '/imgs/27thofit.webp', title: 'Fashion Week', category: 'fashion' },
  ];
